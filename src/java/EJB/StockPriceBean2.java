...
public class StockPriceBean2 implements MessageListener {
...
//        try {
//            connect();
////            String query = "INSERT INTO `client2` (`Reliance`, `TATA`, `Wipro`) VALUES ("+reliance+","+tata+","+wipro+");";
//            String query = "UPDATE `client2` SET `Reliance` = '"+reliance+"', `TATA` = '"+tata+"', `Wipro` = '"+wipro+"' WHERE `client2`.`c2id` = 1;";
//            System.out.println("Query :- " + query);
//            stmt = conn.createStatement();
//            if(stmt.executeUpdate(query) == 1){
//                System.out.println("********** Client 2 Stock Price Updated **********");
//            }else{
...
//                System.out.println("Client 2 has got Stock Price :- " + msg );
//                
