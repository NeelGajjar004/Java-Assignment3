...
public class StockPriceBean3 implements MessageListener {
...
//        try {
//            connect();
////            String query = "INSERT INTO `client3` (`Reliance`, `TATA`, `Wipro`) VALUES ("+reliance+","+tata+","+wipro+");";
//            String query = "UPDATE `client3` SET `Reliance` = '"+reliance+"', `TATA` = '"+tata+"', `Wipro` = '"+wipro+"' WHERE `client3`.`c3id` = 1;";
//            System.out.println("Query :- " + query);
//            stmt = conn.createStatement();
//            if(stmt.executeUpdate(query) == 1){
//                System.out.println("********** Client 3 Stock Price Updated **********");
//            }else{
...
//                System.out.println("Client 3 has got Stock Price :- " + msg );
//                
