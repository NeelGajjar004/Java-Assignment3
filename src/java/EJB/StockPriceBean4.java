...
public class StockPriceBean4 implements MessageListener {
...
//        try {
//            connect();
//            String query = "INSERT INTO `client4` (`Reliance`, `TATA`, `Wipro`) VALUES ("+reliance+","+tata+","+wipro+");";
////            String query = "UPDATE `client4` SET `Reliance` = '"+reliance+"', `TATA` = '"+tata+"', `Wipro` = '"+wipro+"' WHERE `client4`.`c4id` = 1;";
//            System.out.println("Query :- " + query);
//            stmt = conn.createStatement();
//            if(stmt.executeUpdate(query) == 1){
//                System.out.println("********** Client 4 Stock Price Updated **********");
//            }else{
...
//                System.out.println("Client 4 has got Stock Price :- " + msg );
//                
